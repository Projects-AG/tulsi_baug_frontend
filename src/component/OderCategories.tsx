  ...
  return (
    <div className="flex flex-col justify-center items-center h-[50vh] relative">
      <div className="max-w-md text-center">
        <h1
          className="text-[40px] font-bold mb-4 leading-[46px] tracking-normal align-middle"
        ...
        <div className="flex gap-4">
          <input
            ...
            className="w-full max-w-[300px] h-[40px] bg-[#F5F5F5] border border-gray-200 rounded-[12px] p-2"
          />
      ...
      <img
        ...
        className="absolute w-[67px] h-[67px] top-[140px] left-[50%] transform rotate-[-90deg] scale-x-[-1] opacity-100"
      />
