  ...
  return (
    <section className="py-16 px-4 sm:px-6 lg:px-4">
      <div className="max-w-6xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-5 items-center">
        {/* Left - Text */}
        <div className="order-2 lg:order-1 lg:-mt-30">
        ...
        <div className="order-1 lg:order-2 flex justify-center lg:justify-end lg:mr-10">
          <div className="relative w-full max-w-lg">
            <div className="flex flex-col sm:flex-row items-center gap-6 justify-center">
              <img src="/dealsec-img-1.jpg" alt="product" className="rounded-2xl w-full sm:w-56 md:w-64 lg:w-80 h-auto object-cover shadow-lg border" />
              <img src="/dealsec-img-2.jpg" alt="product" className="rounded-2xl w-full sm:w-56 md:w-64 lg:w-80 h-auto object-cover shadow-lg border transform sm:translate-y-6 md:translate-y-8" />
            </div>

            <div className="hidden sm:flex absolute left-1/2 top-1/2 transform -translate-x-1/2 -translate-y-1/2 bg-[#e05659] text-white rounded-full w-30 h-30 flex-col items-center justify-center shadow-lg z-10">
              <span className="text-2xl opacity-80 font-semibold">Save</span>
