...
const sampleProducts = [
  ...
  // Additional items (duplicated/adjusted to make 12 cards)
  {
    id: 7,
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="flex flex-col sm:flex-row items-center justify-end gap-4 mb-6">
          <div className="flex items-center gap-3">
            ...
            <div className="flex items-center gap-2 text-gray-500">
              {/* Grid icon */}
              <button title="Grid view" className="p-2 rounded-md hover:bg-gray-100">
                <svg xmlns="http://www.w3.org/2000/svg" className="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M4 6h4v4H4V6zM10 6h4v4h-4V6zM16 6h4v4h-4V6zM4 12h4v4H4v-4zM10 12h4v4h-4v-4zM16 12h4v4h-4v-4z" />
                </svg>
              </button>
              {/* List icon */}
              <button title="List view" className="p-2 rounded-md hover:bg-gray-100">
                <svg xmlns="http://www.w3.org/2000/svg" className="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-4 gap-6">
          ...
          <main className="lg:col-span-3">
            {/* Showing text above product images (aligned right) */}
            <div className="flex items-center justify-end mb-4">
              <div className="text-sm text-gray-600">Showing 1–12 of 20 results</div>
            </div>
